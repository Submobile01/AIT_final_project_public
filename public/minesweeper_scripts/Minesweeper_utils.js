...
function genField(numMine, config,boardSetup) {
   ...
   */
  function restart(config,boardSetup) {
    config.gameStage = 1;
    config.flagCount = 0;
    config.blockCount = 0;
    config.clickCount = 0;
   ...
   */
  function reGenBlocks(config,boardSetup) {
